...
import { Paper, Box, Modal, ButtonGroup, CardMedia, Badge, Card, CardActions, CardContent, Typography, Backdrop, Fade, IconButton, } from "@mui/material";
...
const ShopIndex = ({ products, handleAddToCart, cart, totalItems }) => {
  ...
  //     {/* {cart?.total_items} */}
  //   </Button>,
  //   <Button variant="contained" key="three">
  //     <AddIcon />
  //   </Button>,
  // ];
  ...
  return (
    <div className="container" style={{ marginBottom: "9rem" }}>
      <div className="mt-5">
        <SectionTitle subheading="I have Some Stuffs Too" heading="Shop" />
      </div>
      <Carousel
        // showDots={true}
      ...
      >
        {products?.map((item, i) => (
          <Card
            sx={{ maxWidth: 345, boxShadow: "2px 22px 10px  pink" }}
            key={item.id}
          >
            ...
            <PreviewIcon
              ...
              sx={{
                fill: "rgba(52, 84, 140, 1)",
                float: "right",
                fontSize: "2rem",
                padding: "3px",
                cursor: "pointer",
                "&:hover": { transform: "rotate(6deg)", color: "red" },
              }}
            />
            <CardMedia
              component="img"
            ...
            >
              ...
              <Box
                component="div"
                sx={{ "&:hover": { transform: "rotate(4deg)" } }}
      ...
      >
        <Fade in={open}>
          <Box component="div" sx={modalStyle}>
            ...
            <Box sx={right}>
              <Box>
                ...
                <Typography
                  ...
                  component="h2"
                >
                  {modalData?.price?.formatted_with_symbol}
                </Typography>
                <Typography
                ...
                >
                  <Button
                    ...
                    onClick={() => handleAddToCart(modalData.id, 1)}
                  >
                    Add to cart
                  </Button>
                </CardActions>
            ...
            <Box sx={{ color: "black", '&:hover': {color: '#111'} }} component={Link} to="/cart">
